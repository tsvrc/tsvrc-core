...
namespace Tsvrc.Editor
{
    ...
    internal sealed class UdonWriter
    {
        ...
        internal void AutoGenHeader()
        {
            ...
            _sb.AppendLine("// Generated by TsvrcGenerator. Do not edit, changes will be overwritten.");
            _sb.AppendLine("// Regenerated automatically on domain reload, or manually via Tsvrc > Force Regenerate.");
        }
