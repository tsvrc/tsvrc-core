...
namespace Tsvrc.Core
{
    ...
    {
        [Tooltip("Core network manager — compiled as a singleton field on CompiledTsvrc. Accessible via _ts.Network. The assigned prefab is instantiated into the scene under CompiledTsvrc on compile.")]
        public TsvrcNetwork Network;
