...
namespace Tsvrc.Core
{
    ...
    /// </summary>
    public class TsBehaviour : UdonSharpBehaviour
    {
        ...
        /// <see cref="TsBehaviour"/> and fully constructs this behaviour. A no-op on
        ...
        /// </summary>
        public void TsConstruct(TsBehaviour parent)
        {
            if (_isConstructed) return;
