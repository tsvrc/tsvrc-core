...
namespace Tsvrc.Editor
{
    ...
    // Tabs come from TsvrcGenerator.CreateModules(), filtered to modules with a non-null TabLabel.
    internal class TsvrcWindow : EditorWindow
    {
        private List<TsvrcModule> _tabs;
        ...
        private void Reload()
        {
            _tabs = TsvrcGenerator.CreateModules().Where(m => m.TabLabel != null).ToList();
