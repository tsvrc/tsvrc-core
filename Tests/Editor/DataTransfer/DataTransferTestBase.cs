namespace Tsvrc.Tests.Editor
{
    ...
    // TsvrcProcessTestBase) to reuse CreateProcess<T>/SeedAsOwner/GetTrackedPlayerIds/
    // GetReadyPlayerIds/ForceNextTickDueNow/etc. - every class in the DataTransfer chain IS a
    // ReadyCheckProcess (IS a PlayerTracker, IS a TsvrcProcess), so every helper built for those
