...
{
    public class TsvrcProcessCleanupTests : TsvrcProcessTestBase
    {
        [Test]
        public void BareTsvrcProcess_FullStartStopLifecycle_NoOverridesRequired_DoesNotThrow()
        {
            var process = CreateProcess<TsvrcProcess>();
            SeedAsOwner(process);
