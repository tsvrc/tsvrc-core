...
{
    // Every dual-authority guard in TsProcess is written as
    ...
    // Tests/PlayMode/Core/TsProcess/ instead.
    public abstract class TsProcessTestBase
    {
        ...
        protected T CreateProcess<T>(string name = null) where T : TsProcess
        {
        ...
        protected static void SeedAsOwner(TsProcess process, int playerId = OwnerPlayerId)
        {
        ...
        protected static bool InvokeIsProcessOwner(TsProcess process)
        {
        ...
        protected static void ForceNextTickDueNow(TsProcess process)
        {
