...
namespace Tsvrc.Tests.Editor
{
    ...
    public class TsvrcTimerUpdateSnapshotTests : TsvrcTimerTestBase
    {
        private static void SeedObserved(TsvrcTimerTestSubclass timer, bool hasObserved, int lastElapsedMs, bool lastIsRunning, bool lastIsPaused)
        {
        ...
        private static void InvokeUpdateElapsedSnapshot(TsvrcTimerTestSubclass timer)
        {
        ...
        public void FirstCallEver_HasObservedStateFalse_FiresEventRegardlessOfElapsedValue()
        {
            ...
            SeedAsOwner(timer);
            timer.TsSubscribe(timer, TsvrcTimer.OnTimerUpdatedEvent, nameof(timer._OnTimerUpdatedEventReceived));
