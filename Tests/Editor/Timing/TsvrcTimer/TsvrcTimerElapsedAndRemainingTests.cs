...
namespace Tsvrc.Tests.Editor
{
    ...
    public class TsvrcTimerElapsedAndRemainingTests : TsvrcTimerTestBase
    {
        [Test]
        public void AllPublicReadAccessors_NeverStarted_ReturnSaneZeroDefaultsWithoutThrowing()
        {
            // Covers the state every TsvrcTimer starts in the instant it's added to a
        ...
        public void LastElapsedMilliseconds_ResetToZeroOnFreshStartAfterPriorRun()
        {
            ...
            // StopTimer's cleanup clears the synced owner fields (TsvrcProcess.InternalCleanup),
