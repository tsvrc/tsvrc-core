...
{
    // TsvrcProcess carries [UdonBehaviourSyncMode], and AddComponent() silently
    ...
    public class TsvrcProcessTestSubclass : TsvrcProcess
    {
    ...
    // TsvrcProcess subclass's own hook. Lives here rather than nested inside a test
    // class for the same AddComponent/Editor-assembly reason as above.
    public class EventingProcess : TsvrcProcessTestSubclass
    {
