...
{
    // Instance.IsTsMaster is already virtual (public virtual bool IsTsMaster => Networking.IsMaster),
    ...
    //
    // [TsCodegenIgnore]: this IS a non-abstract Instance subclass, which is exactly what
    ...
    [TsCodegenIgnore]
    public class InstanceTestSubclass : Instance
    {
