...
namespace Tsvrc.Tests.EditMode
{
    ...
    public class TsProcessTestSubclass : TsProcess
    {
    ...
    // Proves the inherited TsBehaviour pub/sub system works from within a
    // TsProcess subclass's own hook. Lives here rather than nested inside a test
    // class for the same AddComponent/Editor-assembly reason as above.
    public class EventingProcess : TsProcessTestSubclass
    {
