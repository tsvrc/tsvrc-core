...
{
    // Dedicated single-class file - unlike TsvrcBehaviourTestSubclass (which lives in
    // TsvrcBehaviourDoubles.cs alongside several other classes), this file's name matches its
    ...
    public class InstanceModuleWireTestDouble : TsvrcBehaviour
    {
    }
}
