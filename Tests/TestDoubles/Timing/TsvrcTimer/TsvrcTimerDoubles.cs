...
{
    // TsvrcTimer carries TsvrcProcess's [UdonBehaviourSyncMode] attribute, so this double
    // lives in Tsvrc.Tests.Doubles for the same reason PlayerTrackerTestSubclass/
    // TsvrcProcessTestSubclass do (see those files' header comments) - AddComponent()
    ...
    // change-detection", mirroring TsvrcProcessTestSubclass/PlayerTrackerTestSubclass's
    ...
    public class TsvrcTimerTestSubclass : TsvrcTimer
    {
