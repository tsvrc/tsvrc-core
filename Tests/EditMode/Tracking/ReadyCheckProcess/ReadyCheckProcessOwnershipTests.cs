...
{
    // Covers ReadyCheckProcess's own OnOwnerAbandonedProcess override: correcting
    ...
    //
    // PlayerTracker.OnOwnerAbandonedProcess's own scan calls TsPlayer.GetAllPlayers(), which
    ...
    {
        [Test]
        public void OnOwnerAbandonedProcess_ReadyCheckActiveWasStaleFalse_CorrectedToTrueWhileRunning()
        {
        ...
        [Test]
        public void OnOwnerAbandonedProcess_ReadyCheckActiveAlreadyTrue_StaysTrue()
        {
            var tracker = CreateProcess<ReadyCheckProcessTestSubclass>();
            PrivateFieldAccess.SetField(tracker, "_isRunning", true);
        ...
        [Test]
        public void OnOwnerAbandonedProcess_NotRunning_SetsReadyCheckActiveFalse()
        {
            var tracker = CreateProcess<ReadyCheckProcessTestSubclass>();
        ...
        [Test]
        public void OnOwnerAbandonedProcess_ReadyCheckActiveCorrected_SetReadyThenWorksForTheNewOwner()
        {
