...
namespace Tsvrc.Tests.EditMode
{
    ...
    // TsConstruct.
    public class TsvrcBehaviourLoggingTests
    {
        ...
        public void LogWarning_BeforeTsConstruct_FallsBackToDebugLogWithAutoTag()
        {
            ...
            LogAssert.Expect(LogType.Warning, "[TsVRC] [TsvrcBehaviourTestSubclass] fallback path");
        ...
        public void LogError_BeforeTsConstruct_FallsBackToDebugLogWithAutoTag()
        {
            ...
            LogAssert.Expect(LogType.Error, "[TsVRC] [TsvrcBehaviourTestSubclass] fallback path");
        ...
        public void LogWarning_TsConstructedWithRootThatHasNoLogger_StillFallsBackToDebugLog()
        {
            ...
            LogAssert.Expect(LogType.Warning, "[TsVRC] [TsvrcBehaviourTestSubclass] still falls back");
        ...
        public void LogWarning_WorldBehaviour_RoutesThroughWorldToggleNotInternal()
        {
            ...
            // A plain TsvrcBehaviour subclass is "world", so disabling only InternalWarningEnabled
            // must not suppress it.
            LogAssert.Expect(LogType.Warning, "[TsVRC] [TsvrcBehaviourTestSubclass] still world");
