...
namespace Tsvrc.Tests.EditMode
{
    ...
    // outside Play Mode (see TsProcessTestBase), so that branch stays permanently
    ...
    public class TsProcessOwnershipTransferredTests : TsProcessTestBase
    {
        ...
        private static void InvokeOnOwnershipTransferred(Tsvrc.Core.TsProcess process)
        {
