...
namespace Tsvrc.Tests.EditMode
{
    public class TsProcessLifecycleTests : TsProcessTestBase
    {
        ...
        public void StartProcess_AlreadyRunning_IsNoOpAndLogsWarning()
        {
            ...
            LogAssert.Expect(LogType.Warning, "[TsVRC] [TsProcessTestSubclass] Process is already running.");
            process.StartProcess();
        ...
        public void StopProcess_NotRunning_IsNoOpAndLogsWarning()
        {
            ...
            LogAssert.Expect(LogType.Warning, "[TsVRC] [TsProcessTestSubclass] Process is not running.");
            process.StopProcess();
