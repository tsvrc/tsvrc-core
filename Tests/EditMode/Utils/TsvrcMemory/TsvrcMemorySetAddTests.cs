...
namespace Tsvrc.Tests.EditMode
{
    public class TsMemorySetAddTests
    {
        ...
        private static DataDictionary GetTypes(TsvrcMemory memory) => PrivateFieldAccess.GetField<DataDictionary>(memory, "_types");
        ...
        {
            // The underlying DataDictionary indexer rejects a null key outright; TsvrcMemory
        ...
        public void Add_EphemeralKeyAlreadyExists_LogsErrorAndDoesNotOverwrite()
        {
            ...
            LogAssert.Expect(LogType.Error, "[TsVRC] [TsvrcMemory] Key 'k' already exists. Use Set to overwrite.");
