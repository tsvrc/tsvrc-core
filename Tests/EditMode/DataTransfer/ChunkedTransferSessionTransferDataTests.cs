...
namespace Tsvrc.Tests.EditMode
{
    ...
    public class ChunkedTransferSessionTransferDataTests : DataTransferTestBase
    {
        ...
        public void TransferData_AlreadyRunning_WarnsAndDoesNotRestart()
        {
            ...
            LogAssert.Expect(LogType.Warning, "[TsVRC] [ChunkedTransferSessionTestSubclass] Transfer already in progress. Call CancelDataTransfer() first.");
        ...
        public void TransferData_NullPlayerIds_WarnsAndDoesNotStart()
        {
            ...
            LogAssert.Expect(LogType.Warning, "[TsVRC] [ChunkedTransferSessionTestSubclass] Cannot transfer to null or empty player list.");
        ...
        public void TransferData_NullMessage_WarnsViaValidateMessageAndDoesNotStart()
        {
            ...
            LogAssert.Expect(LogType.Warning, "[TsVRC] [ChunkedTransferSessionTestSubclass] Cannot send empty message");
        ...
        public void TransferData_MessageTooLarge_LogsErrorAndDoesNotStart()
        {
            ...
            LogAssert.Expect(LogType.Error, $"[TsVRC] [ChunkedTransferSessionTestSubclass] Message too large: {tooLarge.Length} chars (max {DataChunkerTestSubclass.MaxMessageSizeConst})");
