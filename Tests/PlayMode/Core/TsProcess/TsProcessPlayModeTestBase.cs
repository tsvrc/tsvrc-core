...
namespace Tsvrc.Tests.PlayMode.Core.TsProcess
{
    ...
    public abstract class TsProcessPlayModeTestBase : TsPlayModeTestBase
    {
        ...
        [UnityTearDown]
        public IEnumerator TsProcessPlayModeTestBase_UnityTearDown()
        {
        ...
        protected T CreateProcess<T>(string name = null) where T : Tsvrc.Core.TsProcess
        {
        ...
        // AddComponent<TsProcess>() GameObject can never produce in Play Mode on its own.
        protected static FakeOwnershipSyncable MakeGenuinelyNotUnityOwner(
            Tsvrc.Core.TsProcess process, VRCPlayerApi otherOwner)
        {
