...
namespace Tsvrc.Tests.PlayMode.Core.TsProcess
{
    ...
    // FakeOwnershipSyncable (via TsProcessPlayModeTestBase.MakeGenuinelyNotUnityOwner) to
    // override that fallback for real.
    public class TsProcessOwnershipHandoverPlayModeTests : TsProcessPlayModeTestBase
    {
        [UnityTest]
