...
{
    // Real ClientSim Play Mode tests for TsTimer, following the exact harness/
    // methodology TsProcessOwnershipHandoverTests.cs established for this project:
    ...
    // event-inference logic (already fully covered by TsTimerDeserializationTests.cs).
    ...
    // reflection seeding.
    public class TsTimerPlayModeTests
    {
        ...
        public IEnumerator GetServerTimeMilliseconds_RealClientSim_AdvancesWithRealWallClockTime()
        {
            ...
            TsTimerTestSubclass timer = go.AddComponent<TsTimerTestSubclass>();
            timer.TsConstruct((TsRoot)null);
        ...
        public IEnumerator OnPlayerLeft_RealDepartedOwner_TakeOverPreservesElapsedMathForNewOwner()
        {
            ...
            // Same structural reason as TsProcessOwnershipHandoverTests: ClientSim's
