...
namespace Tsvrc.Tests.PlayMode.UI.TsvrcList
{
    ...
    public class TsListPlayModeTests : TsPlayModeTestBase
    {
        ...
        private Tsvrc.UI.TsvrcList CreateList(int pageSize = -1)
        {
            var listGO = new GameObject(nameof(Tsvrc.UI.TsvrcList));
            _spawned.Add(listGO);
            var list = listGO.AddComponent<Tsvrc.UI.TsvrcList>();
        ...
        private static ListItem[] GetPool(Tsvrc.UI.TsvrcList list) =>
