...
{
    // Real ClientSim Play Mode tests for the one thing TsvrcPlayerPositionOverlay can't
    ...
    // TsvrcPlayerPositionOverlay/) covers everything else - VRCPlayerApi.GetPlayerCount()/
    ...
    public class TsvrcPlayerPositionOverlayPlayModeTests
    {
        ...
        private static TsvrcPlayerPositionOverlay CreateOverlay(string name)
        {
            var go = new GameObject(name);
            var overlay = go.AddComponent<TsvrcPlayerPositionOverlay>();
            overlay.OverlayImage = go.AddComponent<RawImage>();
            overlay.TsConstruct((TsvrcRoot)null);
